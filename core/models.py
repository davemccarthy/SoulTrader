...
class SellInstruction(models.Model):
    ...
    value1 = models.DecimalField(max_digits=14, decimal_places=6, null=True, blank=True, help_text='Primary value (price, percentage, days, threshold, etc.)')
    value2 = models.DecimalField(max_digits=14, decimal_places=6, null=True, blank=True, help_text='Secondary value (e.g., max_days for diminishing/augmenting instructions)')
