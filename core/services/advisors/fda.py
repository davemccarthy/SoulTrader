...
class FDA(AdvisorBase):
    def discover(self, sa):
        ...
        for approval in best_approvals.values():
            ...
            stock = self.discovered(sa, stock_symbol, explanation, None, weight=weight)
            if not stock:
                continue
...
def _get_company_to_symbol_map():
    return {
        ...
        "AVID RADIOPHARMACEUTICALS": "LLY",
        "INSTITUTO GRIFOLS": "GRFS",
        "GRIFOLS": "GRFS",
        "RADIUS HEALTH": "RDUS",
        "CHUGAI PHARMACEUTICAL": "RHHBY",
        "CHUGAI": "RHHBY",
        "CEPHALON": "TEVA",
        "ACTELION": "JNJ",
        "WYETH": "PFE",
        "NOVARTIS VACCINES": "NVS",
        "EMD SERONO": "MKGAY",
        "MERCK KGAA": "MKGAY",
        "INTRA-CELLULAR THERAPIES": "ITCI",
        "MAST THERAPEUTICS": "SVRA",
        "PHARMACIA": "PFE",
